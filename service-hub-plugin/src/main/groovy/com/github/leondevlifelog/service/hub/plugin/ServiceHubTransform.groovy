...
class ServiceHubTransform extends Transform {
    static final String IMPLEMENTS_MANAGER = "com/github/leondevlifelog/core/ServiceHub.class"
    static final String IMPLEMENTS_MANAGER_NAME = "com.github.leondevlifelog.core.ServiceHub"
    Project project

    ServiceHubTransform(Project project) {
    ...
    void transform(TransformInvocation transformInvocation)
            ...
            it.directoryInputs.each {
                ...
                project.fileTree(dst).each {
                    ...
                    if (clazzPath.endsWith(".class")) {
                        ...
                        ServiceProvider annotation = clazz.getAnnotation(ServiceProvider.class)
                        if (annotation != null) {
        ...
        implementsList.each {
            def str = it.serviceProvider.toString()
            log("serviceProvider =" + it.serviceProvider)
